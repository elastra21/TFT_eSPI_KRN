...
//                                                                                           #
int serial_port = 2;     // Use enumerated value from list provided when sketch is run       #
//                                                                                           #
...
int color_bytes = 16;     // 2 for 16 bit, 3 for three RGB bytes (automatic - sent by Arduino)
